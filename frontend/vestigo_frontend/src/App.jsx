...
import LateChargePolicies from './pages/operations/LateChargePolicies';
import LateCharges from './pages/operations/LateCharges';
import LateChargeDetail from './pages/operations/LateChargeDetail';
      ...
      <Routes>
        ...
        <Route element={<PrivateRoute />}>
          <Route path="/" element={<DashboardLayout />}>
            ...
            <Route path="late-charge-policies" element={<LateChargePolicies />} />
            <Route path="late-charges" element={<LateCharges />} />
                        <Route path="late-charges/:id" element={<LateChargeDetail />} />
